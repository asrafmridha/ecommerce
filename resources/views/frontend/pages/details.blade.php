                            ...
                            <div class="row my-2">
                                ...
                                <div class="col-12 col-md-7">
                                    ...
                                    <div class="ecommerce-details-price d-flex flex-wrap mt-1">
                                        <h4 class="item-price mr-1">${{ $product->product_price }}</h4>
                                    ...
                                    <div class="d-flex flex-column flex-sm-row pt-1">
                                        <button value="{{ $product->id }}"  href="javascript:void(0)" class="btn btn-primary btn-cart mr-0 mr-sm-1 mb-1 mb-sm-0 addtocart">
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <a href="javascript:void(0)">
                                            ...
                                            <div class="img-container w-50 mx-auto py-75">
                                                <img src="{{ asset('frontend') }}/app-assets/images/elements/apple-watch.png" class="img-fluid" alt="image" />
                                            </div>
                                            <div class="item-meta">
                                    ...
                                    <div class="swiper-slide">
                                        <a href="javascript:void(0)">
                                            ...
                                            <div class="img-container w-50 mx-auto py-50">
                                                <img src="{{ asset('frontend') }}/app-assets/images/elements/macbook-pro.png" class="img-fluid" alt="image" />
                                            </div>
                                            <div class="item-meta">
                                                <ul class="unstyled-list list-inline mb-25">
                                                    <li class="ratings-list-item"><i data-feather="star" class="filled-star"></i></li>
                                    ...
                                    <div class="swiper-slide">
                                        <a href="javascript:void(0)">
                                            ...
                                            <div class="img-container w-50 mx-auto py-75">
                                                <img src="{{ asset('frontend') }}/app-assets/images/elements/homepod.png" class="img-fluid" alt="image" />
                                            </div>
                                            <div class="item-meta">
                                                <ul class="unstyled-list list-inline mb-25">
                                                    <li class="ratings-list-item"><i data-feather="star" class="filled-star"></i></li>
                                    ...
                                    <div class="swiper-slide">
                                        <a href="javascript:void(0)">
                                            ...
                                            <div class="img-container w-50 mx-auto py-75">
                                                <img src="{{ asset('frontend') }}/app-assets/images/elements/magic-mouse.png" class="img-fluid" alt="image" />
                                            </div>
                                            <div class="item-meta">
                                                <ul class="unstyled-list list-inline mb-25">
                                                    <li class="ratings-list-item"><i data-feather="star" class="filled-star"></i></li>
                                    ...
                                    <div class="swiper-slide">
                                        <a href="javascript:void(0)">
                                            ...
                                            <div class="img-container w-50 mx-auto py-75">
                                                <img src="{{ asset('frontend') }}/app-assets/images/elements/iphone-x.png" class="img-fluid" alt="image" />
                                            </div>
                                            <div class="item-meta">
                                                <ul class="unstyled-list list-inline mb-25">
                                                    <li class="ratings-list-item"><i data-feather="star" class="filled-star"></i></li>
